...
* **Compatibilidade de software**
  A maioria dos programas, jogos e aplicações do mercado é desenvolvida pensando no Windows, o que amplia muito suas possibilidades de uso.

* **Observação importante (Código aberto)**
